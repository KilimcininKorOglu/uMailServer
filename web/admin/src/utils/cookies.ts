...
// preferences (language, theme, admin email/password-change markers) live in
// cookies. The auth JWT itself stays in a separate HttpOnly cookie the client
// cannot read — these helpers are for non-sensitive readable state only.
