  ...
  it('accepts a valid typed per-section server config', () => {
    const cfg: ServerConfig = {
      ...
      smtp: {
        ...
        submission: { enabled: true, port: 587, bind: '0.0.0.0', require_auth: true, max_connections: 100 },
      ...
      imap: { enabled: true, port: 993, bind: '0.0.0.0', idle_timeout_secs: 1800, max_connections: 100 },
      ...
      security: {
        require_tls_for_auth: true, max_login_attempts: 5, lockout_secs: 900, disable_legacy_jwt: false, spf_cache_ttl_secs: 300,
