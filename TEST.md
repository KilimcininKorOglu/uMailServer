...
- `helper-projects/proto_mapi_ext.py` — MAPI/HTTP OAB derinliği: OAB dizin listesi (alice+bob), HiddenFromGAL uçtan uca (oda kur → OAB'de gör → gizle → düş), OAB tam/artımlı indirme
