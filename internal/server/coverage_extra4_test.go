...
func TestCoverDeliverLocal_UserNotFound(t *testing.T) {
	...
	err = srv.deliverLocal("nonexistent", "example.com", "sender@example.com", []byte("Test message"), false, nil)
	if err == nil {
...
func TestCoverDeliverLocal_QuotaExceeded(t *testing.T) {
	...
	err = srv.deliverLocal("testuser", "example.com", "sender@example.com", []byte("Test message"), false, nil)
	if err == nil {
